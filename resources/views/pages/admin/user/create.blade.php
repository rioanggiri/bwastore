                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="password-visibility-toggle">
                                                <label class="form-check-label" for="password-visibility-toggle">Show Password</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
