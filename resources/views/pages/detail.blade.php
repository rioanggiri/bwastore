                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8">
                            <ul class="list-unstyled">
                                <li class="media">
                                    <img src="/images/icon-testimonial-1.png" alt="Testimonial 1"
                                ...
                                <li class="media">
                                    <img src="/images/icon-testimonial-2.png" alt="Testimonial 2"
                                        class="mr-3 rounded-circle">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img src="/images/icon-testimonial-3.png" alt="Testimonial 3"
                                        class="mr-3 rounded-circle">
                                    <div class="media-body">
